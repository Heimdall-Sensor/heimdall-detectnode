...
*/
#ifndef _HEIMDALL_DD_NODE_
#define _HEIMDALL_DD_NODE_
...
namespace Heimdall
{
    ...
    enum class DetectNodeMode {IDLE, CALIBRATE, DETECT};

    class DetectNodeException : public std::exception
    {
        public:
            DetectNodeException(char const *msg) : d_msg(msg) {}
            DetectNodeException(std::string const &msg) : d_msg(msg) {}
            ~DetectNodeException() noexcept {};
    ...
    class DetectNode
    {
        public:
            ...
            void setMasksConfig(heimdall_detectnode::DetectNodeConfig &config);
        ...
        private:
            ...
            ros::Publisher d_rviz_mask_marker_pub;

            heimdall_detectnode::DetectNodeConfig d_config;
    };
}
